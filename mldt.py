...
Original file is located at
    https://colab.research.google.com/drive/1tX4husCRzxJNs0CwzVtyjaEbdK_D7EGL
"""
...
if __name__ == '__main__':
    # Reading data
    d = pd.read_csv("/content/drive/MyDrive/play_tennis.csv")[['outlook', 'temp', 'humidity','wind','play']].dropna()

    # Constructing the X and Y matrices
    X = d[['outlook', 'temp', 'humidity','wind']]
    Y = d['play'].values.tolist()
